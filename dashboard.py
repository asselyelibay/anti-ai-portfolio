...
# TITLE
st.title("🛡️ Anti-AI Bubble Portfolio Dashboard")
...
if len(tickers) > 1:
    ...
    if max_sharpe_result.success:
        ...
        with col1:
            st.metric("📈 Annual Return", f"{ret_sharpe*100:.2f}%")
        with col2:
            st.metric("📊 Volatility", f"{vol_sharpe*100:.2f}%")
        with col3:
        ...
        st.error("❌ Optimization failed. Try selecting different assets or adjusting parameters.")
...
# FOOTER
st.markdown("---")
st.markdown("**Developed by Assel Yelibay** | IÉSEG School of Management")
